    ...
    <div className="container" style={{marginTop:"1%"}}>
      ...
      <div className="container" style={{marginTop: "5%"}}>
        <div className="row justify-content-around">
          ...
          <div className="col-4" style={{borderRadius: "50px 10px 50px 10px",border: "1px solid black"}}>
              <img src="https://www.google.com/search?q=airbnb+linkedin&tbm=isch&ved=2ahUKEwiirJa4mJbuAhUGchQKHTz-CTsQ2-cCegQIABAA&oq=Airbnb+link&gs_lcp=CgNpbWcQARgAMgQIABAYOgQIIxAnOgIIADoECAAQQzoECAAQHlD5HljjKGDPMGgAcAB4AYAB8AKIAeAFkgEHMy4xLjAuMZgBAKABAaoBC2d3cy13aXotaW1nwAEB&sclient=img&ei=iXr9X-LDIobkUbz8p9gD&bih=937&biw=1920&rlz=1C1GCEU_pt-PTPT924PT924#imgrc=n1VRHVKl2xhG9M" 
                width="200" height="200" className={styles.imaged}/>
              <h3 className={styles.fonted}>
                  Date: {formatDate(Date.now() - 86400000)}
              </h3>
