  ...
  return (
    <div className="container-fluid" style={{marginTop:"1%"}}>
      ...
      <div className="container" style={{marginTop:"5%"}}>
        <div className="row">
          <div className="col-5">
            <img src="https://media-exp1.licdn.com/dms/image/C560BAQEn0TOcIOwYcA/company-logo_200_200/0/1562074722126?e=2159024400&v=beta&t=2kaPJ87Ymep2V_Nppv3Neph6Qb9Sk4YHs-iwSWcchz8" width="50" height="50" />
