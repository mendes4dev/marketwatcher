...
export default function Home({allData}) {
  ...
  return (
    <div className="container" style={{marginTop:"1%"}}>
      ...
      <div className="container" style={{marginTop: "5%",borderRadius: "15px 50px",border: "1px solid black"}}>
        <div className="row justify-content-center">
          <div className="col-4" style={{marginTop: "5%",borderRadius: "15px 50px",border: "1px solid black"}}>
